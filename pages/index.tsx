...
// Raw product type from the DummyJSON API
type ApiProduct = {
  id: number;
  title: string;
  description: string;
            ...
            products.map((product) => (
              <div key={product.id} className="relative">
                ...
                >
                  ...
                  />
                  <h2 className="text-base font-bold text-gray-900 dark:text-white group-hover:text-blue-600 mb-1">
                    {product.name}
                  </h2>
                  <p className="text-gray-500 dark:text-gray-400 mb-1 text-xs italic">
                    {product.category}
                  </p>
                  <p className="text-gray-600 dark:text-gray-300 mb-1 text-xs truncate w-full">
                    {product.description}
                  </p>
                  <span className="text-base font-semibold text-blue-600 dark:text-blue-400 mb-2">
                    {product.price}
                  </span>
                  {product.rating && (
                  ...
                  <span className="mt-1 text-blue-500 hover:underline text-xs">
                    View Details
                  </span>
                </Link>
              </div>
